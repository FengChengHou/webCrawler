...
public abstract class StringUtil {
	...
	/**
	 * 把ISO-8859-1编码格式的字符串转换成UTF-8编码格式
	 * 
	 * @param str
	 *            原字符串
	 * @return 返回转换编码格式后字符串
	...
	/**
	 * 对字符串进行sql格式化，并且符合like查询的格�?
	 * 
	 * @param likeStr
	 *            要验证的字符�?
	 * @return 格式化后的字符串
	 */
	public static String escapeMysqlLikeStr(String likeStr) {
		if (likeStr == null || likeStr.equals(""))
			return "";
		likeStr = likeStr.replaceAll("\\\\", "\\\\\\\\");
		likeStr = likeStr.replaceAll("%", "\\\\%");
		likeStr = likeStr.replaceAll("_", "\\\\_");
		return likeStr;
	}

	/**
	 * 去除字符串前后的{}如{abc}返回abc
	 * 
	 * @author DingFengHua
	 * @since Mar 30, 2012
	 * @param str
	 * @return
	 */
	public static String fixValidForReject(String str) {
		if (str == null) {
			return null;
		}
	...
	public static String DoubleToStringFormat(double val) {
        String p = String.valueOf(val * 100D);
        int ix = p.indexOf(".") + 1;
	 ...
	 * @return
	 */
	public static String random(int captchaCodeLength){
        String elegibleChars = "abcdefhjkmnpqrstuvwxy3456789";
        String captchaCode = "";
        ...
        captchaCode = finalString.toString();
		return captchaCode;
	}
